...
const Detailpage = () => {
    ...
    const [games, setGames] = useState([
        ...
        // Additional games for other categories
    ...
    // Function to add a new game to the games array
    const addNewGame = (newGame) => {
        // Update games state with the new game added
        setGames(prevGames => [...prevGames, newGame]);
    };

    return (
        <div className="detail-page">
            {/* Assuming Sidebar and Navbar components are imported and used correctly */}
                    ...
                    <div className="footer-main">
                        ...
                        <div className="footer-section">
                            ...
                            <ul>
                                ...
                                <li><a href="#">Diamondease Affiliates Program</a></li>
                                <li><a href="#">FAQ</a></li>
